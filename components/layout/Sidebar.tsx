...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-72 bg-[#f8f9fa] shadow-[32px_0_64px_-20px_rgba(0,0,0,0.04)] flex flex-col z-40 border-r border-outline-variant/10">
      {/* Logo area */}
